      ...
      <div className="w-full md:w-3/5 bg-white rounded-lg p-6 shadow-md">
        ...
        <div className="space-y-6">
          {[1, 2, 3].map((_, idx) => (
            <div
              key={idx}
              className="flex flex-col md:flex-row bg-green-100 p-4 rounded-lg shadow-md h-64"
            >
              ...
              <div className="flex flex-col space-y-2 md:w-1/2">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <button className="mt-1 px-3 py-1 bg-green-300 text-green-800 rounded-full text-sm">
                      Get in Touch
                    </button>
                  </div>
                </div>
                ...
                {/* Read More */}
                <div>
                  <button className="text-[#9EDF9C] text-sm">Read more...</button>
                </div>
              </div>

              {/* Right Section - Photos */}
              <div className="flex flex-wrap items-center justify-center md:w-1/2 gap-2 mt-4 md:mt-0">
