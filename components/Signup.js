  ...
  return (
    <Layout>
      <div
        ...
        style={{
          backgroundImage: `url('/images/bg.png')`, // Correct path to the public folder
        }}
      >
        <h4 className="text-4xl text-white sm:text-5xl md:text-6xl">Signup</h4>
        <input
          className="w-full max-w-[400px] mx-auto px-3 duration-200 hover:border-white focus:border-white py-2 sm:py-2 border border-solid border-white rounded-full outline-none"
          placeholder="Email"
        />
        <input
          className="w-full max-w-[400px] mx-auto px-3 duration-200 hover:border-white focus:border-white py-2 sm:py-2 border border-solid border-white rounded-full outline-none"
